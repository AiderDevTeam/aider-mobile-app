    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index){
        ...
        return Column(
          ...
          children: [
            SizedBox(
              child: product.hasPhotos? NetworkImageView(
            ...
            Text(product.name?? '')
                .textMaxLines(1).medium().fontSize(14).color(kGrey1200).overflowText(TextOverflow.ellipsis).paddingOnly(right: 12.0),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(product.address?.originName?? '')
                        .regular()
                        .fontSize(12)
                        .color(kGrey700).overflowText(TextOverflow.ellipsis).flexible(),
                  ],
                ).flexible(),
                ...
                Row(
                  children: [
                    ...
                    Text("${product.rating ?? 0.0}").regular().fontSize(12).color(kGrey700)
                  ],
                ),
              ],
