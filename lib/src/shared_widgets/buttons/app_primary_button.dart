      ...
      child: Theme(
        ...
        child: MaterialButton(
          ...
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(AppThemeUtil.radius(radius ?? 12.0)),
            side: BorderSide(
          ...
          child: Text(
            ...
            style: textStyle ??
                kSemiBoldFontStyle.copyWith(
                  ...
                  color: onPressed != null
                      ? AppThemeUtil.getThemeColor(textColor ?? kPrimaryWhite)
                      : AppThemeUtil.getThemeColor(const Color(0xFF98A2B3)),
                ),
