...
abstract class ReviewRepository {
  Future<Either<Failure, ProductHistoryModel>> fetchVendorProductsAndReviews(
      {String? userExternalId,
      String? nextPage,
      required Map<String, dynamic> queryParam});
  Future<Either<Failure, ReviewHistoryModel>> fetchRenterReviews(
      {String? userExternalId,
      String? nextPage,
      required Map<String, dynamic> queryParam});
  Future<Either<Failure, ReviewHistoryModel>> fetchVendorReviews(
      {String? userExternalId,
      String? nextPage,
      required Map<String, dynamic> queryParam});
}
...
class ReviewRepositoryImpl extends ReviewRepository {
  ...
  Future<Either<Failure, ProductHistoryModel>> fetchVendorProductsAndReviews(
    ...
    try {
      final response =
          await reviewRemoteDataSource.fetchVendorProductsAndReviews(
  ...
  Future<Either<Failure, ReviewHistoryModel>> fetchRenterReviews(
      ...
      required Map<String, dynamic> queryParam}) async {
    try {
      final response = await reviewRemoteDataSource.fetchRenterReviews(
          userExternalId: userExternalId,
          nextPage: nextPage,
          queryParam: queryParam);
      return Right(response);
  ...
  Future<Either<Failure, ReviewHistoryModel>> fetchVendorReviews(
      ...
      required Map<String, dynamic> queryParam}) async {
    try {
      final response = await reviewRemoteDataSource.fetchVendorReviews(
          userExternalId: userExternalId,
          nextPage: nextPage,
          queryParam: queryParam);
      return Right(response);
