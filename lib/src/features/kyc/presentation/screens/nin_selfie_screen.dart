...
class NinSelfieScreen extends StatefulWidget {
  const NinSelfieScreen({super.key});

  @override
  State<NinSelfieScreen> createState() => _NinSelfieScreenState();
}

class _NinSelfieScreenState extends State<NinSelfieScreen> {
