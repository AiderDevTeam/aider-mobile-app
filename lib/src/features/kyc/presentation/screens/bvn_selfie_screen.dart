...
class BvnSelfieScreen extends StatefulWidget {
  const BvnSelfieScreen({super.key});

  @override
  State<BvnSelfieScreen> createState() => _BvnSelfieScreenState();
}

class _BvnSelfieScreenState extends State<BvnSelfieScreen> {
