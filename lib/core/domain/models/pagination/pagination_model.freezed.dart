...
class _$PaginationModelImpl implements _PaginationModel {
  const _$PaginationModelImpl(
      {this.previous, this.next, this.currentPage, this.perPage, this.total});
  ...
  @override
  String toString() {
    return 'PaginationModel(previous: $previous, next: $next, currentPage: $currentPage, perPage: $perPage, total: $total)';
  }
